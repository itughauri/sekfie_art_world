        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('booking.store') }}" id="ticket_submit">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="no_of_tickets" class="label_tickets">Number of
                                    tickets</label>
                                <input type="number" class="form-control" name="no_of_tickets" id="no_of_tickets" required>
                            </div>
                            <button style="width: 100%" class="btn btn-primary generate">Book Ticket</button>
                        </form>
                    </div>
                </div>
            </div>
